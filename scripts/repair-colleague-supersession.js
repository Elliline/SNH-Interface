 ...
 * the 7/8 "Its Jaime, i was spelling it wrong" correction stored a new fact
 * but never superseded the misspelled original, so "Jamie" kept re-surfacing
 ...
 *   8b05824b (Jamie/manager)            → superseded by bd135dee (Jaime/Director of Rooms at IEC)
 *   c7a04ab6 (Jaime dupe, salience 10) → superseded by bd135dee (which inherits salience 10)
 *   71c821de (IEC-client dupe, sal. 1)   → superseded by b77ce55a (7/7 defining fact)
 ...
 * finds nothing to do.
 *
 * Usage: node scripts/repair-colleague-supersession.js [--apply]
...
const REPAIRS = [
  {
    ...
    why: 'user correction 7/8 + 7/16: her name is Jaime, not Jamie, and she is Director of Rooms'
  },
  {
    oldId: 'c7a04ab6-d456-468d-b440-97596bb31855',
    newId: 'bd135dee-33d8-4798-abe6-1a02044acea1',
    why: 'duplicate of the fuller 7/8 Jaime fact (re-extracted from today\'s re-correction)'
  },
  {
...
(async () => {
  ...
  for (const r of REPAIRS) {
    ...
    const supRes = await factStore.supersede(r.oldId, r.newId, {
      caller: 'scripts/repair-colleague-supersession.js',
      ledger: {
        tier: 'mechanical',
