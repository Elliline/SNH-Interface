...
const FAITHFUL = [
  ...
  ['the dogs-and-cats count (100% kept, and only one distinctive token)',
   'User has 2 dogs and 3 cats, and the user\'s aunt has 1 dog.',
   'User has 2 dogs and 3 cats, and User\'s aunt has 1 dog.'],
  ['the human-food rule (60% kept — the worst faithful write measured)',
   ...
   "User's aunt has a habit of feeding the dogs in the kitchen, and is frustrated when others feed them human food. User strictly follows the rule of only feeding her dogs dog food and treats."]
];
