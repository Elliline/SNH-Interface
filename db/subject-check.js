 ...
 * Example Animal Clinic email on 2026-08-26:
 *
 *   1. "User works at IEC (Inn At Example Cove), a business located at 123 NE
 *      Example Hwy, Example City, OR 00000, ..."   — the clinic's street address,
 *      asserted as Inn at Example Cove's location. IEC is not mentioned
 *      ANYWHERE in the source email; the address came off the sender's
 *      signature block.
 *   2. "User's business email is eac2009@example.com"  — the clinic's address
 ...
 * prose, and treating "123 NE EXAMPLE HWY / Example City, OR 00000 / email:
 * eac2009@example.com" as one continuous sentence with whatever preceded it is
 * precisely how the clinic's address ended up attributed to Inn at Example Cove.
 */
...
function unitContains(unit, claim, { sourceIsUserMessage = true } = {}) {
  ...
  if (claim.kind === 'address') {
    // Compare loosely: "123 NE Example Hwy" against "123 NE EXAMPLE HWY".
