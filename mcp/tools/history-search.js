    ...
    this.parameters = {
      ...
      properties: {
        question: {
          type: 'string',
          description:
            'The question, in your own words, as a full question — "what did the script for Example City ' +
...
class HistoryFindTool extends BackgroundHistoryTool {
  constructor() {
    ...
    this.parameters = {
      type: 'object',
      properties: {
        query: { type: 'string', description: 'The words to look for. "Example Animal Clinic script", "backup schedule decision".' },
